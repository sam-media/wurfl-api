 ...
 *  test case.
 */
class WURFL_Request_UserAgentNormalizer_ChromeTest
    extends WURFL_Request_UserAgentNormalizer_BaseTest
{
    ...
    {
        self::assertNormalizeEqualsExpected($userAgent, $expected);
    }
