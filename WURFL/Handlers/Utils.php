...
class WURFL_Handlers_Utils
{
    ...
    /**
     * Returns the character position (index) of the $target in $string, starting from a given index.  If target is not
     * found, returns length of user agent.
     *
    ...
    public static function isDesktopBrowserHeavyDutyAnalysis($userAgent)
    {
        ...
        if (self::checkIfContains($userAgent, 'PPC')) {
            return false;
